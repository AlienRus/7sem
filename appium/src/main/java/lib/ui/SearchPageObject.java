...
public class SearchPageObject extends  MainPageObject {
    ...
    private static  final String SAVE_BUTTON = "//android.widget.TextView[@content-desc=\"Save\"]";
    private static  final String BACK_BUTTON = "//android.widget.ImageButton[@content-desc=\"Navigate up\"]";
    private static  final String SAVE_LIST = "//android.widget.FrameLayout[@content-desc=\"Saved\"]";
    ...
    private static final String SAVED_TITLE_DELETE_OPTION = "//android.widget.TextView[@resource-id=\"org.wikipedia:id/title\" and @text=\"Remove all from offline\"]";
